...
# 2. name
name = "frida" #string variable
# 3. song
song = "Modo DND" #string variable
# 4. food
food = "wings" #string variable
# 5. number
...
#f strings
print("Once upon a time, there was a " + str(age) + " older coder named " + name + ".")


# What is syntax ? What is an algorithm?
#syntas is the way we write code
